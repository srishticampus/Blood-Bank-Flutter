import 'dart:convert';
import 'dart:io';
import 'package:blood_bank_application/API/EmergencyalertAPI/model/emergencymodel.dart';
  ...
  Future getAllEmergencyRequestData({required BuildContext context}) async {
    try {
      ...
      var response = await https.get(
        Uri.parse(
            "http://campus.sicsglobal.co.in/Project/Blood_Bank/phpfiles/api/view_emergency_request.php"),
      );
      ...
      if (response.statusCode == 200) {
        ...
        print('pet details' + _emergency.toString());
        _isLoading = false;
